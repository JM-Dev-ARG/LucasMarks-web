...
const $$BtnWhatsApp = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a class="btnWA" href="https://walink.co/efb238" target="_blank" data-astro-cid-z2zk3xxb> ${renderComponent($$result, "Image", $$Image, { "src": img$2, "alt": "whatsapp", "class": "img", "data-astro-cid-z2zk3xxb": true })} <img data-astro-cid-z2zk3xxb> </a> `;
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="../../assets/img/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head> ${renderComponent($$result, "NavBar", $$NavBar, {})} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BtnWhatsApp", $$BtnWhatsApp, {})} ${renderComponent($$result, "Footer", $$Footer, {})} </html>`;
