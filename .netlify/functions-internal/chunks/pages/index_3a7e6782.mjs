...
const $$NavBar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$NavBar;
  return renderTemplate`${maybeRenderHead()}<div class="flex w-full  items-start justify-around bg-slate-50 sticky py-3 top-0 z-10 shadow-md"> <a href="#inicio" class="cursor-pointer h-[60px] grid place-items-center"> ${renderComponent($$result, "Image", $$Image, { "src": img$1, "class": "h-[52.8px] w-[250px] top-0", "alt": "Lucas Marks, asesor de seguros - logo" })} </a> <div class="flex items-center justify-center  "> <ul class="flex items-center justify-center gap-6 h-[60px] max-[600px]:hidden"> <li><a id="navItem" href="#servicios" class="text-slate-950 hover:text-[#17A2B8] font-semibold text-lg">Sercicios</a></li> <li><a id="navItem" href="#contacto" class="text-slate-950 hover:text-[#17A2B8] font-semibold text-lg">Contacto</a></li> </ul> <div class="collapse min-[601px]:hidden p-0 "> <input type="checkbox" id="menu"> <div class="collapse-title grid place-items-center p-0 " id="menuLogo"> <svg width="32" height="32" viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg"> <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4.5 6.5h12m-12.002 4h11.997M4.5 14.5h11.995"></path> </svg> </div> <div class="collapse-content p-0 pb-0 "> <ul class="flex flex-col gap-2 "> <li><a id="navItem" href="#servicios" class="text-slate-950 hover:text-[#17A2B8] font-semibold text-md">Sercicios</a></li> <li><a id="navItem" href="#contacto" class="text-slate-950 hover:text-[#17A2B8] font-semibold text-md">Contacto</a></li> </ul> </div> </div> </div> </div>  `;
...
const $$Servicios = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const data = Data$2;
  return renderTemplate`${maybeRenderHead()}<p class="text-6xl text-slate-800 mt-12">Servicios</p> <div class="flex items-center justify-evenly  my-10 lg:my-15 md:gap-4 max-[900px]:flex-col lg:gap-6 lg:flex-row w-full px-4"> ${data.map((doc) => renderTemplate`${renderComponent($$result, "CardServicio", $$CardServicio, { "title": doc.title, "icon": doc.icon, "body": doc.body, "visible": doc.visible })}`)} </div>`;
