...
const img$2 = new Proxy({"src":"/_astro/whatsapp.34c61e9d.webp","width":80,"height":80,"format":"webp"}, {
...
const $$BtnWhatsApp = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a class="fixed bottom-[1.25rem] right-[1.25rem] z-50 border-none outline-none cursor-pointer" href="https://walink.co/efb238" target="_blank"> ${renderComponent($$result, "Image", $$Image, { "src": img$2, "alt": "whatsapp", "class": "w-[2.5rem] h-[2.5rem]" })} </a>`;
}, "D:/webs/LucasMarks/src/components/BtnWhatsApp.astro", void 0);

const img$1 = new Proxy({"src":"/_astro/logo.91514d07.webp","width":138,"height":144,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
Desarrollado por <a href="https://github.com/JM-Dev-ARG" target="_blank">JM-DEV</a> / Agencia Panambi
</p>`;
...
Somos intermediarios líderes entre vos y las principales compañías de
      seguros. Logramos los mejores costos y beneficios, garantizando muy buena
      atención y el respaldo que brinda un Broker Corporativo.
</p> </div> </header> `;
...
const Data$1 = [
	{
		id: 1,
		img: "../../assets/img/hogar.webp",
		title: "HOGAR",
		btn: "https://walink.co/3ad4b1"
	},
	{
		id: 2,
		img: "../../assets/img/autos.webp",
		title: "automotores",
...
const $$CardDetalle = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="card w-[250px] 2xl:w-[500px] flex lg:flex-col"> <figure> <img${addAttribute(icon, "src")}${addAttribute(title, "alt")} class="max-sm:h-[100px] max-sm:w-[100px] max-[770px]:h-[120px] max-[770px]:w-[120px] h-[140px] w-[140px] 2xl:w-[180px] 2xl:h-[180px]"> </figure> <div class="card-body items-center text-center text-slate-950 p-0 lg:mt-3 2xl:mt-8 md:m-0"> <h2 class="card-title h-5 mb-1 2xl:text-4xl 2xl:mb-3">${title}</h2> <p class="h-28 text-sm leading-tight 2xl:text-2xl">${body}</p> </div> </div>`;
